...
public class JoyfulMomentSpeechmaticsClient {
    ...
    public void connect(String language, String operatingPoint, Integer maxDelaySec, String eventTypesCsv) {
        Request request = new Request.Builder()
                .url(url)
                .header("Authorization", "Bearer " + apiKey)
                .build();
        webSocket = okHttpClient.newWebSocket(request, new InternalListener(language, operatingPoint, maxDelaySec, eventTypesCsv));
    }
    ...
    private class InternalListener extends WebSocketListener {
        ...
        private final Integer maxDelaySec;
        private final String eventTypesCsv;

        InternalListener(String language, String operatingPoint, Integer maxDelaySec, String eventTypesCsv) {
        ...
        public void onOpen(WebSocket webSocket, Response response) {
            try {
                ...
                if (maxDelaySec != null && maxDelaySec > 0) {
                    transcriptionConfig.put("max_delay", maxDelaySec);
                }
